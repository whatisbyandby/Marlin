...
#define STRING_CONFIG_H_AUTHOR "(Perkins, Creality Ender-5 Plus)" // Who made the changes.
...
// Suppress DIAG pins warning (DIAG pins physically removed)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -60, -13, -1.6 }
